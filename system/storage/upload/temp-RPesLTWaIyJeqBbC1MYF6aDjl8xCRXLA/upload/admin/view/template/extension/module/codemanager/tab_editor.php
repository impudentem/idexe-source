...
$('#showModal').on('click', function(e){
	...
	$("#CustomerData").load('index.php?route=<?php echo $module_path; ?>/givecredentials&token=<?php echo $token; ?>');
});
$('#showUsers').on('click', function(e){
	$('#modalUsers').modal('show');
	$("#data").load('index.php?route=<?php echo $module_path; ?>/showusers&token=<?php echo $token; ?>');
});
