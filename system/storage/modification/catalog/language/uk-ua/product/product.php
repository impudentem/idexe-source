...
$_['text_year']                               = 'рік';
				...
				$_['entry_fo_button']                             = 'Швидка покупка';
				...
				$_['entry_fo_message']                            = 'Ваше запитання:';
				$_['entry_fo_message_error']                      = 'Будь ласка, задайте своє питання або залиште коментар до замовлення.';
				$_['entry_fo_close']                              = 'Закрити';
				$_['entry_fo_send']                               = 'Швидка покупка!';
				$_['entry_fo_send_success']                       = "Ваше замовлення успішно оформлене! <br /> Менеджер зв'яжеться з Вами найближчим часом.";
				$_['entry_fo_send_error']                         = "Замовлення не може бути оформлене. <br /> Зв'яжіться з нами будь-яким іншим зручним способом.";
