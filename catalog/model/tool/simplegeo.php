...
class ModelToolSimpleGeo extends Model {
    ...
    public function getGeoList($city) {
        ...
        if (!$geo_data) {
            ...
            $sql = "SELECT g.id,g.fullname,g.name,g.postcode,z.zone_id,z.country_id FROM simple_geo g LEFT JOIN " . DB_PREFIX . "zone z ON g.zone_id = z.zone_id WHERE g.name LIKE '" . $this->db->escape($city) . "%' ORDER BY name ASC LIMIT 100";
            /*$sql = "SELECT
                f1.fias_id AS id,
