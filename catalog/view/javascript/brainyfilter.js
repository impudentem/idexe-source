    ...
    //        var searchFilters = {};
        ...
        shrinkBlock: function(block, items, disableAnim) {
            ...
            if (!items) {
                ...
                $(block).closest('.bf-attr-block').find('.bf-arrow').removeClass('expanded').addClass('collapse');
                $(block).closest('.bf-attr-block').find('.bf-arrow').css('background-position', '0 0');
            }
        ...
        expandBlock: function(block, disableAnim) {
            ...
            wrapper.addClass('bf-expanded');
            $(block).parents('.bf-attr-block').find('.bf-arrow').removeClass('collapse').addClass('expanded');
            $(block).parents('.bf-attr-block').find('.bf-arrow').css('background-position', '0 0');
        },
        ...
        collapse: function() {
            ...
            $('.bf-collapse').parents('.bf-attr-block').find('.bf-arrow').removeClass('expanded').addClass('collapse');
            $('.bf-collapse').parents('.bf-attr-block').find('.bf-arrow').css('background-position', '0 0');
