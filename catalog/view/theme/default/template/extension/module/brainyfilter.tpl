                ...
                <?php foreach ($filters as $i => $section) : ?>
                    ...
                    <?php if ($section['type'] == 'price') : ?>
                        ...
                        <div class="bf-attr-header<?php if ($section['collapsed']) : ?> bf-collapse<?php endif; ?><?php if (!$i) : ?> bf-w-line<?php endif; ?>">
                            <?php echo $lang_price; ?><span class="bf-arrow <?php if ($section['collapsed']) : ?>collapse<?php else: ?>expanded<?php endif; ?>">"></span>
                        </div>
                    ...
                    <?php elseif ($section['type'] == 'search') : ?>
                        ...
                        <div class="bf-attr-header<?php if ($section['collapsed']) : ?> bf-collapse<?php endif; ?><?php if (!$i) : ?> bf-w-line<?php endif; ?>">
                            <?php echo $lang_search; ?><span class="bf-arrow <?php if ($section['collapsed']) : ?>collapse<?php else: ?>expanded<?php endif; ?>"></span>
                        </div>
                        <div class="bf-attr-block-cont">
                    ...
                    <?php elseif ($section['type'] == 'category') : ?>
                        ...
                        <div class="bf-attr-header<?php if ($section['collapsed']) : ?> bf-collapse<?php endif; ?><?php if (!$i) : ?> bf-w-line<?php endif; ?>">
                            <?php echo $lang_categories; ?><span class="bf-arrow <?php if ($section['collapsed']) : ?>collapse<?php else: ?>expanded<?php endif; ?>">"></span>
                        </div>
                        <div class="bf-attr-block-cont">
                            <?php $groupUID = 'c0'; ?>
                            ...
                            <?php else : ?>
                                ...
                                <div class="bf-attr-filter bf-attr-<?php echo $groupUID; ?> bf-row <?php if (isset($totals) && isEmptyStock($groupUID, $catId, $postponedCount, $totals, $selected) && $settings['behaviour']['hide_empty']): ?>bf-disabled<?php endif; ?>">
                                    <span class="bf-cell bf-c-1">
                                        ...
                                        <?php if ($section['control'] === 'checkbox') { ?>
                                            <label for="bf-attr-<?php echo $groupUID . '_' . $catId . '_' . $layout_id; ?>"></label>
                                        <?php } ?>
                    ...
                    <?php else : ?>
                        ...
                        <?php foreach ($section['array'] as $groupId => $group) : ?>
                            ...
                            <div class="bf-attr-header<?php if ($section['collapsed']) : ?> bf-collapse<?php endif; ?><?php if (!$i) : ?> bf-w-line<?php endif; ?>">
                                <?php echo $group['name']; ?><span class="bf-arrow <?php if ($section['collapsed']) : ?>collapse<?php else: ?>expanded<?php endif; ?>">"></span>
                            </div>
                            <div class="bf-attr-block-cont">
                                    ...
                                    if (isset($totals) && isEmptyStock($groupUID, $valueId, $postponedCount, $totals, $selected) && $settings['behaviour']['hide_empty']):
                                        ...
                                        <span class="bf-cell bf-c-1">
                                            <input id="bf-attr-<?php echo $groupUID . '_' . $valueId . '_' . $layout_id; ?>"
                                                ...
                                                <label for="bf-attr-<?php echo $groupUID . '_' . $valueId . '_' . $layout_id; ?>"></label>
                                                <?php } ?>
                                        </span>
