...
<div class="cart">
  <button>
    <span class="cart-icon">158</span>
    <span class="total-sum-val">15322</span><span class="total-sum-cur">грн</span>
  </button>
</div>
-->

<div id="cart" class="btn-group cart">
  <button type="button" data-toggle="dropdown" data-loading-text="<?php echo $text_loading; ?>" class="cart-button dropdown-toggle"><span id="cart-total"><?php echo $text_items; ?></span></button>
