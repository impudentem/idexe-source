              ...
              <div class="tab-content">
                ...
                <div class="tab-pane" id="language<?php echo $language['language_id']; ?>">
                  ...
                  <div class="form-group required">
                        ...
                        <div class="col-sm-10">
                            <textarea class="form-control summernote" name="article_description[<?php echo $language['language_id']; ?>][intro_text]" placeholder="<?php echo $entry_intro_text; ?>" id="input-intro-text<?php echo $language['language_id']; ?>"><?php echo isset($article_description[$language['language_id']]) ? $article_description[$language['language_id']]['intro_text'] : ''; ?></textarea>
                        </div>
                  </div>
                  <div class="form-group required">
				  ...
				  <div class="form-group">
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label" for="input-stick"><?php echo $entry_stick; ?></label>
                        <div class="col-sm-10">
                            <div class="checkbox">
                            <?php if ($stick) { ?>
                            <input style="margin-left: 0;" name="stick"  id="input-stick" type="checkbox" value="1" checked />
                            <?php } else { ?>
                            <input style="margin-left: 0;" name="stick"  id="input-stick" type="checkbox" value="1" />
                            <?php } ?>
                            </div>
                        </div>
                    </div>
                ...
                <div class="table-responsive">
                    <table class="table table-striped table-bordered table-hover">
                        ...
                        <tbody>
                            <tr>
                                <td class="text-left">
                                    <a href="" id="thumb-image" data-toggle="image" class="img-thumbnail"><img src="<?php echo $thumb; ?>" alt="" title="" data-placeholder="<?php echo $placeholder; ?>" /></a><input type="hidden" name="image_main" value="<?php echo $image_main; ?>" id="input-image" />
                                </td>
                            </tr>
                        </tbody>
                    </table>
