              ...
              <table id="images<?php echo $language['language_id']; ?>" class="table table-striped table-bordered table-hover">
                ...
                <tbody>
                  ...
                  <tr id="image-row<?php echo $image_row; ?>">
                    ...
                    <td class="text-left"><textarea name="banner_image[<?php echo $language['language_id']; ?>][<?php echo $image_row; ?>][description]" value="<?php echo $banner_image['description']; ?>" placeholder="<?php echo $entry_description; ?>" class="summernote form-control"><?php echo $banner_image['description']; ?></textarea>
                      <?php if (isset($error_banner_image[$language['language_id']][$image_row])) { ?>
                      <div class="text-danger"><?php echo $error_banner_image[$language['language_id']][$image_row]; ?></div>
                      <?php } ?></td>
                    ...
                    <td class="text-left" style="width: 30%;">
                      ...
                      <input type="text" class="form-control" name="banner_image[<?php echo $language['language_id']; ?>][<?php echo $image_row; ?>][link_text]" value="<?php echo $banner_image['link_text']; ?>" placeholder="<?php echo $entry_link_text; ?>" />
...
function addImage(language_id) {
  ...
  html += '  <td class="text-left" style="width: 30%;"><input type="text" name="banner_image[' + language_id + '][' + image_row + '][link_text]" value="" placeholder="<?php echo $entry_link_text; ?>" class="form-control" /><input type="text" name="banner_image[' + language_id + '][' + image_row + '][link]" value="" placeholder="<?php echo $entry_link; ?>" class="form-control" /></td>';
