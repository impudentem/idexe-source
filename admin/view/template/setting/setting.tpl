        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-setting" class="form-horizontal">
          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="tab-store">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-fax"><?php echo $entry_slogan; ?></label>
                <div class="col-sm-10">
                  <?php foreach ($languages as $language) { ?>
                    <div class="input-group"><span class="input-group-addon"><img src="language/<?php echo $language['code']; ?>/<?php echo $language['code']; ?>.png" title="<?php echo $language['name']; ?>" /></span>
                      <input type="text" name="config_slogan[<?php echo $language['language_id']; ?>]" value="<?php echo isset($config_slogan[$language['language_id']]) ? $config_slogan[$language['language_id']] : ''; ?>" placeholder="<?php echo $entry_slogan; ?>" class="form-control" />
                    </div>
                  <?php } ?>
                </div>
              </div>
