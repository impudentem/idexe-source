            ...
            <div class="tab-pane active" id="tab-general">
              ...
              <div class="tab-content">
                ...
                <div class="tab-pane" id="language<?php echo $language['language_id']; ?>">
                  ...
                  <div class="form-group">
                    <label class="col-sm-2 control-label" for="input-h1<?php echo $language['language_id']; ?>"><?php echo $entry_h1; ?></label>
                    <div class="col-sm-10">
                      <input name="category_description[<?php echo $language['language_id']; ?>][h1]" rows="5" placeholder="<?php echo $entry_h1; ?>" value="<?php echo isset($category_description[$language['language_id']]) ? $category_description[$language['language_id']]['h1'] : ''; ?>" id="input-h1<?php echo $language['language_id']; ?>" class="form-control">
                    </div>
                  </div>
                  <div class="form-group required">
