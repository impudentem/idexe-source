          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <select name="template" id="input-template" class="form-control">
                <option value="0" <?php if($template == 0) { ?>selected="selected"<?php }?>><?php echo $entry_template_0; ?></option>
                <option value="1" <?php if($template == 1) { ?>selected="selected"<?php }?>><?php echo $entry_template_1; ?></option>
                <option value="2" <?php if($template == 2) { ?>selected="selected"<?php }?>><?php echo $entry_template_2; ?></option>
              </select>
            </div>
          </div>
          <div class="form-group">
