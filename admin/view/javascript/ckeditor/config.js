...
CKEDITOR.editorConfig = function( config ) {
    ...
    config.contentsCss = [CKEDITOR.getUrl('../../stylesheet/bootstrap.css'),CKEDITOR.getUrl('plugins/glyphicons/css/css/bootstrap.css'),CKEDITOR.getUrl('plugins/fontawesome/font-awesome/css/font-awesome.min.css')];
