...
class ControllerExtensionModuleHTML extends Controller {
	...
	public function index() {
        ...
        $data['entry_template_0'] = $this->language->get('entry_template_0');
        $data['entry_template_1'] = $this->language->get('entry_template_1');
        $data['entry_template_2'] = $this->language->get('entry_template_2');
        ...
        if (isset($this->request->post['class'])) {
            $data['class'] = $this->request->post['status'];
        } elseif (!empty($module_info)) {
        ...
        if (isset($this->request->post['template'])) {
            $data['template'] = $this->request->post['design'];
        } elseif (!empty($module_info)) {
