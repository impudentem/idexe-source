	...
	protected function getList() {
		...
		foreach ($results as $result) {
			$data['comments'][] = array(
                ...
                'status_link' => ($result['status']) ? $this->url->link('blog/comment/switchCommentStatus', 'token=' . $this->session->data['token'] . '&comment_id=' . $result['comment_id']. '&to_status=0'  . $url, 'SSL') : $this->url->link('blog/comment/switchCommentStatus', 'token=' . $this->session->data['token'] . '&comment_id=' . $result['comment_id']. '&to_status=1'  . $url, 'SSL'),
		...
		$data['sort_article'] = $this->url->link('blog/comment', 'token=' . $this->session->data['token'] . '&sort=ad.name' . $url, 'SSL');
		...
		$data['sort_date_modified'] = $this->url->link('blog/comment', 'token=' . $this->session->data['token'] . '&sort=c.date_modified' . $url, 'SSL');
